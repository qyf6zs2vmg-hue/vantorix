          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-3xl md:text-5xl font-bold text-stone-900 leading-tight">
                Мы — технологический партнер, <span className="text-stone-400">создающий мощные цифровые системы для автоматизации операций и масштабирования.</span>
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
           ...
           >
              ...
              <div className="p-10 flex flex-col flex-grow bg-white">
                 <div>
                   <h3 className="text-3xl font-bold text-stone-900 mb-3">Orderly by Vantorix</h3>
