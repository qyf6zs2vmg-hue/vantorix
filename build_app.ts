      ...
      <footer className="py-8 bg-white border-t border-stone-200 relative z-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          ...
          <div className="text-sm text-stone-500 flex flex-wrap justify-center gap-6">
            <a href="#" className="hover:text-stone-900 transition-colors">Политика конфиденциальности</a>
            <a href="#" className="hover:text-stone-900 transition-colors">Условия оказания услуг</a>
          </div>
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 w-full mt-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight leading-[1.05] mb-8 text-stone-900">
              Цифровые системы <br className="hidden lg:block"/>
          ...
          <motion.p 
            ...
            className="text-xl md:text-3xl text-stone-600 font-light mb-12 max-w-4xl mx-auto leading-relaxed"
          >
            Разрабатываем сайты, системы и приложения, которые <span className="text-[#C25B3A] font-medium">автоматизируют процессы</span> и <span className="text-stone-900 font-medium">упрощают работу бизнеса.</span>
          </motion.p>
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-3xl md:text-4xl lg:text-5xl font-medium text-stone-900 leading-tight">
              ...
              <span className="text-stone-400">Погружаемся в бизнес-логику, фокусируемся на эффективности, помогаем компаниям оцифровывать операции и объединяем мощную инженерию с премиальным дизайном.</span>
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
            ...
            <p className="text-xl md:text-2xl text-stone-600 leading-relaxed max-w-4xl mx-auto font-light">
              Мы разрабатываем <span className="text-stone-900 font-medium">кастомные веб-сайты</span> для каждого бизнеса. <br className="hidden md:block"/>От посадочных страниц и корпоративных порталов <br className="hidden md:block"/>до интегрированных клиентских систем. Никаких шаблонов.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section id="process" className="py-32 px-6 relative overflow-hidden">
        <div className="max-w-5xl mx-auto">
          <div className="mb-20 text-center">
            ...
            <p className="text-xl text-stone-600 max-w-2xl mx-auto">Инженерный, пошаговый подход для точного достижения целей бизнеса.</p>
          </div>
...
`;
fs.writeFileSync(path.resolve(process.cwd(), 'src/App.tsx'), content);
