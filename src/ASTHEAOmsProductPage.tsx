...
export default function ASTHEAOmsProductPage() {
  React.useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
              <a 
                href="https://asthea-oms.vercel.app/" target="_blank" rel="noreferrer"
          ...
          >
            ...
            <div className="relative w-full aspect-[4/3] radius-ui border border-[var(--border)] bg-[var(--card)]  overflow-hidden flex flex-col">
              ...
              <div className="flex-1 flex bg-[var(--bg-muted)] relative overflow-hidden">
                ...
                {/* Right side: ASTHEA OMS */}
                <div className="flex-1 p-4 flex flex-col gap-4 bg-[var(--card)] relative">
                  <div className="absolute top-2 left-2 text-[10px] uppercase font-bold text-[var(--accent-icon)] tracking-wider">After (ASTHEA)</div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
            ...
            <h2 className="text-3xl md:text-5xl font-black text-[var(--text-primary)] mb-8">
              ASTHEA OMS централизует все B2B заказы в одной автоматизированной платформе.
            </h2>
          </motion.div>
